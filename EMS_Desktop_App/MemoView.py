...
class Ui_MemoWindow(object):
    def setupUi(self, MemoWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8("icons/upload-icon-32.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8("icons/fb_601351.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8("icons/pic.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.image_text.setGeometry(QtCore.QRect(60, 310, 471, 33))
